    ...
    for event in sense.stick.get_events():
        if event.action =="pressed":
            if event.direction =="right":
                  ...
                  if temperature > 22 and humidity >= 10:
                      ...
                      sense.show_message("No hace mucho calor", text_colour=green)

                  elif temperature > -15 and temperature <= 10 and humidity > 35 and humidity < 39:
                      sense.show_message("Brr, hace mucho frio. Apaga el aire acondicionado", text_colour=blue)

                  elif temperature >= 100:
                      sense.show_message("Hace mucho calor, ¿Me has metido en el horno?", text_colour=red)

                  elif temperature >= 35:
                      sense.show_message("La temperatura es muy alta, Enciende el aire acondicionado", text_colour=orange)
                      
                  elif temperature <= -15:
                      sense.show_message("La temperatura es muy baja! Apaga ya mismo el aire acondicionado y sal de la casa!", text_colour=white)
